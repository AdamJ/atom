        ...
        <script type="text/javascript" src="../prettydiff-min.js">
            ...
            (function () {
                ...
                var args = {},
                    ...
                    outerror = function (x) {
                        ...
                        if (WScript.Arguments.Count() === 0 || help === true) {
                            ...
                            error.push("");
                            error.push("* jsscope      - boolean - If true JavaScript beautification produces HTML formatted output coloring function scope and variables to indicate scope depth and inheritance. Default is false.");
                            error.push("");
                ...
                if (fail === false) {
                    ...
                    args.jsscope = (WScript.Arguments.Named("jsscope") === "true" || WScript.Arguments.Named("jsscope") === true) ? true : false;
                    ...
                    args.topcoms = (WScript.Arguments.Named("topcoms") === "true" || WScript.Arguments.Named("topcoms") === true) ? true : false;
